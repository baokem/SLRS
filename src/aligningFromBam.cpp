...
AligningResultHead * GetAligningResultHead(char * readFile, char * leftBamFile, char * rightBamFile, char * alignmentResultFile,ContigSetHead * contigSetHead, bool aligning, int contigLengthThreshold, int endlength, int sortbarcode){
